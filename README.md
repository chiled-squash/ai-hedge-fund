...
# For running LLMs hosted by aliyun
# Get your Aliyun API key from https://bailian.console.aliyun.com/
DASHSCOPE_API_KEY=your-aliyun-api-key
```

**Important**: You must set `OPENAI_API_KEY`, `GROQ_API_KEY`, `DASHSCOPE_API_KEY`,or `ANTHROPIC_API_KEY` for the hedge fund to work.  If you want to use LLMs from all providers, you will need to set all API keys.
